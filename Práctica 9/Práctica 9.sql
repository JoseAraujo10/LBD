USE [Hotel]
GO
/****** Object:  Trigger [AltaEmpleado]    Script Date: 02/11/2019 10:04:12 p. m. ******/
DROP TRIGGER IF EXISTS [dbo].[AltaEmpleado]
GO
/****** Object:  StoredProcedure [dbo].[ReservacionesPorTrabajo]    Script Date: 02/11/2019 10:04:12 p. m. ******/
DROP PROCEDURE IF EXISTS [dbo].[ReservacionesPorTrabajo]
GO
/****** Object:  StoredProcedure [dbo].[Recepcionistas]    Script Date: 02/11/2019 10:04:12 p. m. ******/
DROP PROCEDURE IF EXISTS [dbo].[Recepcionistas]
GO
/****** Object:  StoredProcedure [dbo].[Gerentes]    Script Date: 02/11/2019 10:04:12 p. m. ******/
DROP PROCEDURE IF EXISTS [dbo].[Gerentes]
GO
/****** Object:  StoredProcedure [dbo].[EmpleadasDeLimpieza]    Script Date: 02/11/2019 10:04:12 p. m. ******/
DROP PROCEDURE IF EXISTS [dbo].[EmpleadasDeLimpieza]
GO
/****** Object:  StoredProcedure [dbo].[Botones]    Script Date: 02/11/2019 10:04:12 p. m. ******/
DROP PROCEDURE IF EXISTS [dbo].[Botones]
GO
...
GO
/****** Object:  Table [dbo].[Tipo_Servicios]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Tipo_Servicios]
GO
/****** Object:  Table [dbo].[Tipo_Habitacion]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Tipo_Habitacion]
GO
/****** Object:  Table [dbo].[Temporada]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Temporada]
GO
/****** Object:  Table [dbo].[Reservaciones]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Reservaciones]
GO
/****** Object:  Table [dbo].[Puesto_Empleado]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Puesto_Empleado]
GO
/****** Object:  Table [dbo].[Pais]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Pais]
GO
/****** Object:  Table [dbo].[Metodo_Pago]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Metodo_Pago]
GO
/****** Object:  Table [dbo].[Huesped]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Huesped]
GO
/****** Object:  Table [dbo].[Hotel]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Hotel]
GO
/****** Object:  Table [dbo].[Historial]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Historial]
GO
/****** Object:  Table [dbo].[Estado_Habitacion]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Estado_Habitacion]
GO
/****** Object:  Table [dbo].[Estado]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Estado]
GO
/****** Object:  Table [dbo].[Empleados]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Empleados]
GO
/****** Object:  Table [dbo].[ClientesDeEUA]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[ClientesDeEUA]
GO
/****** Object:  Table [dbo].[Ciudad]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Ciudad]
GO
/****** Object:  View [dbo].[HabitacionesMatrimoniales]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP VIEW IF EXISTS [dbo].[HabitacionesMatrimoniales]
GO
/****** Object:  View [dbo].[HabitacionesIndividuales]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP VIEW IF EXISTS [dbo].[HabitacionesIndividuales]
GO
/****** Object:  View [dbo].[SevicioPiscina]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP VIEW IF EXISTS [dbo].[SevicioPiscina]
GO
/****** Object:  Table [dbo].[Servicios]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Servicios]
GO
/****** Object:  View [dbo].[HabitacionesOcupadas]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP VIEW IF EXISTS [dbo].[HabitacionesOcupadas]
GO
/****** Object:  View [dbo].[HabitacionesDisponibles]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP VIEW IF EXISTS [dbo].[HabitacionesDisponibles]
GO
/****** Object:  Table [dbo].[Habitaciones]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Habitaciones]
GO
/****** Object:  UserDefinedFunction [dbo].[FechaConLetras]    Script Date: 02/11/2019 10:04:13 p. m. ******/
DROP FUNCTION IF EXISTS [dbo].[FechaConLetras]
GO
USE [master]
GO
/****** Object:  Database [Hotel]    Script Date: 02/11/2019 10:04:13 p. m. ******/
...
GO
create function [dbo].[FechaConLetras] (@fecha as date)
returns varchar(20)
begin
...
SET QUOTED_IDENTIFIER ON
GO
create view [dbo].[HabitacionesDisponibles] as select * from Habitaciones where idEstadoHabitacion=2
GO
/****** Object:  View [dbo].[HabitacionesOcupadas]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create view [dbo].[HabitacionesOcupadas] as select * from Habitaciones where idEstadoHabitacion=1
GO
/****** Object:  Table [dbo].[Servicios]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
...
SET QUOTED_IDENTIFIER ON
GO
create view [dbo].[SevicioPiscina] as select * from Servicios where idTipoServicio=2
GO
/****** Object:  View [dbo].[HabitacionesIndividuales]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create view [dbo].[HabitacionesIndividuales] as select * from Habitaciones where idTipoHabitacion=1
GO
/****** Object:  View [dbo].[HabitacionesMatrimoniales]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create view [dbo].[HabitacionesMatrimoniales] as select * from Habitaciones where idTipoHabitacion=3
GO
/****** Object:  Table [dbo].[Ciudad]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ClientesDeEUA](
...
GO
INSERT [dbo].[ClientesDeEUA] ([Nombre_Huesped], [ApellidoP_Huesped]) VALUES (N'Allen', N'Styles')
GO
INSERT [dbo].[ClientesDeEUA] ([Nombre_Huesped], [ApellidoP_Huesped]) VALUES (N'Bryan', N'Loyd')
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Botones]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[Botones]
as select * from Empleados where idPuesto=4
GO
/****** Object:  StoredProcedure [dbo].[EmpleadasDeLimpieza]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[EmpleadasDeLimpieza]
as select * from Empleados where idPuesto=2
GO
/****** Object:  StoredProcedure [dbo].[Gerentes]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[Gerentes]
as select * from Empleados where idPuesto=3
GO
/****** Object:  StoredProcedure [dbo].[Recepcionistas]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[Recepcionistas]
as select * from Empleados where idPuesto=1
exec Recepcionistas
GO
/****** Object:  StoredProcedure [dbo].[ReservacionesPorTrabajo]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[ReservacionesPorTrabajo]
as select * from Reservaciones where MotivoVisita='Trabajo'
GO
/****** Object:  Trigger [dbo].[AltaEmpleado]    Script Date: 02/11/2019 10:04:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create trigger [dbo].[AltaEmpleado] 
on [dbo].[Empleados] for insert 
as 
begin 
insert into Historial values (getdate(),'Alta Empleado', system_user)
end
GO
ALTER TABLE [dbo].[Empleados] ENABLE TRIGGER [AltaEmpleado]
GO
USE [master]
GO
